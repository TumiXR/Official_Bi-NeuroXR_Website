                ...
                <form action="#">
                    ...
                    <div className='login-register'>
                        <p>Don't have an account?
                            <button className="register-btn" onClick={onFlip}>Register</button>
                        </p>
                    </div>

                    <div className='continue'>
                        <p>OR</p>
                        <p className='cw_text'>Continue using</p>
                                
                    <div className='social-icons'>
                        <div onClick={() => handleOAuth('github')}>
                        ...
                        <div onClick={() => handleOAuth('discord')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div onClick={() => handleOAuth('facebook')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
